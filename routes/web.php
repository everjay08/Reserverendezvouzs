...
use App\Http\Controllers\User\DeliveryDetailController;
...
//DeliveryDetail
Route::get('/api/Delivery-Details', [DeliveryDetailController::class, 'index']);
Route::post('/api/Delivery-Detail', [DeliveryDetailController::class, 'store']);
Route::get('/api/Delivery-Detail/{id}', [DeliveryDetailController::class, 'show']);
Route::patch('/api/Delivery-Detail/{id}', [DeliveryDetailController::class, 'update']);
Route::delete('/api/Delivery-Detail/{id}', [DeliveryDetailController::class, 'destroy']);
